...
const Header = ({ data }) => {
    ...
    if(!data.social_links) return null;
    ...
    return (
        <div className="container px-auto text-white">
            ...
            <div className="d-flex justify-content-around my-5">
                <a className="interactable text-white" href={data.social_links.linkedin}>
                ...
                <a  className="interactable text-white" href={data.social_links.github}>
                ...
                <a  className="interactable text-white" href={data.social_links.twitter}>
